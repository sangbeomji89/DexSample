Moralis.initialize({Application ID}); // MainNetApplication id from morlis.io
Moralis.serverURL = {Server URL}; // MainNetServer url from moralis.io
...
async function init() {
  ...
  console.log("ApplicationID", process.env.ApplicationID);
...
function selectToken(address) {
  ...
  //let address = div.getAttribute("data-address");
...
async function getQuote() {
  ...
  const quote = await Moralis.Plugins.oneInch.quote({
    ...
    toTokenAddress: currentTrade.to.address, // Your wallet address
    amount: amount,
  })
